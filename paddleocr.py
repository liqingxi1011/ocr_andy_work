...
def parse_args(mMain=True):
    ...
    parser.add_argument("--det", type=str2bool, default='./whl/det/ch/ch_PP-OCRv3_det_infer')
    parser.add_argument("--rec", type=str2bool, default='./whl/rec/ch/ch_PP-OCRv3_rec_infer')
